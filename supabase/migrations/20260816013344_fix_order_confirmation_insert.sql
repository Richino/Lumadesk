...
begin
  ...
  insert into public.orders (id, confirmation_number, user_id, email, status, subtotal_cents, tax_cents, shipping_cents, total_cents, stripe_checkout_session_id, stripe_payment_intent_id, shipping_address)
  values (
    v_order_id,
